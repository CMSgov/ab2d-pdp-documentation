...
The [AB2D Data Dictionary](https://ab2d.cms.gov/data_dictionary.html) outlines the data available in each API version. The [AB2D Data Migration Guide] explains the data differences between API versions.
